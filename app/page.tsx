      ...
      <main className="flex-1 flex flex-col items-center justify-center px-6 py-12">
        <div className="max-w-4xl mx-auto text-center mb-12 animate-fade-in-up">
          <h1 className="text-4xl sm:text-5xl font-bold text-warm-gray-900 mb-4 tracking-tight">
            ...
            <span className="text-sky-600">DHH Interim</span>
          </h1>
          ...
          >
            ...
            <div className="relative z-10">
              ...
              <p className="text-warm-gray-600 text-sm leading-relaxed mb-4">
                District staff can submit DHH interim referral packets for students requiring special education services.
              </p>
        ...
        <div className="mt-8 animate-fade-in-up animation-delay-250">
          <Link
            href="/referrals/status"
            className="inline-flex items-center gap-2 text-sm font-medium text-warm-gray-600 hover:text-sky-600 transition-colors bg-cream-100/80 hover:bg-cream-100 px-5 py-2.5 rounded-full border border-cream-200"
          >
            <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" />
            </svg>
            Already submitted? Check your referral status
          </Link>
        </div>
